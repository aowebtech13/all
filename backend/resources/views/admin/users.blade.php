            ...
            <table class="table table-lg">
                <thead>
                    <tr class="bg-slate-50/50 border-b border-slate-100">
                        ...
                        <th class="font-bold text-[14px] uppercase tracking-[0.15em] text-slate-400 text-center">Source</th>
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-all duration-200 group">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <div class="flex items-center gap-3 mt-1">
                                        @if($user->age)
                                            <div class="text-[12px] text-slate-500 font-black uppercase tracking-widest">
                                                <i class="fas fa-user mr-1 text-slate-300"></i> {{ $user->age }} Years
                                            </div>
                                        @endif
                                        @if($user->phone)
                                            <div class="text-[12px] text-primary font-black uppercase tracking-widest">
                        ...
                        <td class="text-center">
                            @if($user->source === 'enterprise')
                                <span class="badge bg-indigo-50 text-indigo-600 border-none font-black text-[12px] px-3 py-1 h-auto rounded-full uppercase tracking-widest">Enterprise</span>
                            @else
                                <span class="badge bg-slate-100 text-slate-500 border-none font-black text-[12px] px-3 py-1 h-auto rounded-full uppercase tracking-widest">Main App</span>
                            @endif
                        </td>
                        <td class="text-center">
