...
<head>
    ...
    <title>Reset Password - Admin Leacent</title>
    ...
    <div class="max-w-md w-full bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 p-10 lg:p-12 border border-slate-200">
        <div class="text-center mb-10">
            <div class="flex items-center justify-center mx-auto mb-8">
                <img src="https://Leacent.com/images/logo.png" alt="Leacent" class="h-16 w-auto">
            </div>
        ...
        <form action="{{ route('admin.password.reset') }}" method="POST" class="space-y-6">
            ...
            <div class="form-control">
                ...
                <input type="email" name="email" class="input border-slate-200 rounded-2xl bg-slate-50 font-bold focus:bg-white focus:border-slate-900 transition-all h-14" value="{{ old('email') }}" placeholder="johndoe@gmail.com" required />
            </div>
